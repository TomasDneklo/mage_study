...
class Study_News_Block_Adminhtml_News_Edit_Tab_Products_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_study_news';
    ...
    protected function _addColumnFilterToCollection($column)
    {
        ...
        $productIds = $this->getSelectedProductsIds();
