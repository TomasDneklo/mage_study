 ...
 * @author HausO
 */
class Study_News_Block_Adminhtml_News_Edit_Tab_Content
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
     ...
     *
     * @return Study_News_Block_adminhtml_News_Edit_Tab_Content
     */
    ...
    protected function _prepareForm(){
        ...
        $fieldset = $form->addFieldset('content_fieldset', array(
            'legend' => Mage::helper('study_news')->__('Content'),
            'class'  => 'fieldset-wide'
        ));
        ...
        // Setting custom render for content field to remove label column
    ...
    {
        return Mage::helper('study_news')->__('Content');
    }
